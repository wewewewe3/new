...
$(document).ready(function() {
	...
	function preProcess(context) {	
		...
		var createEventSunbscription = function(evName, attrId) {
			...
			eventHandlers.action = eventHandlers.action || function(event) {
				var ex;
				try {
			...
			var ex;
			try {
				elements.unbind(eventHandlers.action);
			} catch (ex) {
			}
			elements.bind(evName, eventHandlers.action);
		}
